...
<iframe src="../chat.php" width="600" height="100%" name="chat" align="left">Atualize seu navegador.</iframe><br><iframe name="ultimo" src="../ultima.php" frameborder="0" width=300 height=16 marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling=no>Favor atualizar seu navegador.</iframe><br><br><hr size="1" color="white">
...
<input type="text" name="texto"><input type="submit" value="Alertar!">
 ...
 <form action="#" method="post" target="chat"> 
<input name="nick" type="hidden" value="<font color=red>Moderador</font color=red>">
<input name="acao" type="hidden" value="<font color=red>alerta</font color=red>">
<input type="text" name="texto" value="!NÃO ESTA FUNCIONANDO!" readonly="true"><input type="submit" value="KICKAR!" readonly="true">
</form>
...
<form action="../banip.php" method="post" target="chat">
<input name="nick" type="hidden" value="<font color=red>Moderador</font color=red>">
<input name="acao" type="hidden" value="<font color=red>alerta</font color=red>">
<input type="text" name="texto"><input type="submit" value="BANIR IP!">
</form>
<form action="../desban.php" method="post" target="chat">
<input type="text" name="texto"><input type="submit" value="DESBANIR!">
</form>
<form action="../desbanip.php" method="post" target="chat">
<input type="text" name="texto"><input type="submit" value="DESBANIR IP!">
</form>
<form action="../gravar.php" method="post" target="chat">
<input name="nick" type="hidden" value="<font color=red><?php echo "$user"; ?></font color=red>">
